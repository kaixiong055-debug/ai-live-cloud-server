...
public class PermissionServiceImpl implements PermissionService {
    ...
    @Resource
    @Lazy  // 打破 RoleServiceImpl ↔ PermissionServiceImpl 的循环依赖
    private RoleService roleService;
    @Resource
    @Lazy  // 打破 MenuServiceImpl ↔ PermissionServiceImpl 的循环依赖
    private MenuService menuService;
    @Resource
    private DeptService deptService;
    @Resource
    @Lazy  // 打破 AdminUserServiceImpl ↔ PermissionServiceImpl 的循环依赖
    ...
    @Override
    public Set<String> getGrantedPermissions(Long userId, Collection<String> permissions) {
        ...
        return roleMenuMapper.selectGrantedPermissions(
                TenantContextHolder.getRequiredTenantId(), roleIds, permissions);
    }
